...
<body>
  ...
  <nav>
    ...
    <a href="#impact">Societal Impact</a>
  </nav>
  <div class="container">
    <section id="about">
    ...
    <section id="data">
      ...
      <ul>
        <li>Energy drinks (80–160 mg caffeine) produced the largest average HR increase: +20 bpm</li>
        <li>Coffee (95 mg) resulted in moderate HR changes: +15–18 bpm</li>
        <li>Soda (40 mg) and iced tea (30 mg) had minimal HR changes: ~+6–8 bpm</li>
        <li>Systolic BP increased by 10–18 points in high-dose cases</li>
        <li>Reported symptoms included jitteriness, anxiety, heightened focus, and in two cases, hand tremors</li>
      </ul>
      <p>
        The data confirms that caffeine affects the teenage body in measurable, significant ways, and that dosage and source matter greatly.
      </p>
    </section>
